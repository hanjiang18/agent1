...
#endif
{
 ...
 void ClientHandler::grab(const cv::Mat& im, const cv::Mat& depthmap, const double& timestamp){
    // Check reset
    {
    ...
    mpTracking-> GrabImageRGBD(im, depthmap, timestamp);
    //cout<<"grab"<<endl;
 }
...
void ClientHandler::CamImgCb(sensor_msgs::ImageConstPtr pMsg)
{
    ...
    cout<<"eeeeeeeuuuuuuuuuuueeeeeeeeeee"<<endl;
