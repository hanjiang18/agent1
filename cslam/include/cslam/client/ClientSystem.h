...
public:
    ClientSystem(ros::NodeHandle Nh, ros::NodeHandle NhPrivate, const string &strVocFile, const string &strCamFile,const eSensor sensor);
    void  PassRgbd(const cv::Mat& im, const cv::Mat& depthmap, const double& timestamp);
